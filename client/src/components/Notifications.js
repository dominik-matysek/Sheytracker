...
function Notifications({ showNotifications, setShowNotifications }) {
	...
	return (
		<Modal
			...
			width={1000}
		>
			{/* Przydałoby się też może usuwanie poszczególnych powiadomień - czyli np. mały X przy kazdym, który przy naciśnięciu kasuje powiadomienie */}
				...
				{notifications.map((notification) => (
					<div
						...
						onClick={() => {
							...
							// jak to niżej działa niby? - w ProjectInfo/Tasks/index.js jest onClick (linijka 71)
